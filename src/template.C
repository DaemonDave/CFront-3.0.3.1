...
//! \note template_hier doubled variable put here as an external symbol
extern int template_hier; // interim solution: permit Y<t> to match X<t>
...
///
//
//! \note removed the function [has_templ_instance] outward to template_hier.c
//
///
//
